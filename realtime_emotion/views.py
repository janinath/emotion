...
def index(request):
    return render(request, "realtime_emotion/index.html")
face_exp_model = load_model(r'C:\Users\janisha\face_recognition\datasets\facial_expression_model_combined.h5')
#capture the video from default camera 
webcam_video_stream = cv2.VideoCapture(0)
def emotion_detection(request):
   if request.method == 'POST':
    
    global face_exp_model
    global webcam_video_stream
    # face_exp_model = load_model('C:\Users\janisha\face_recognition\datasets\facial_expression_model_combined.h5')
